...
class StarLink : public Satellite
{
	public:
		...
		{ 
			...
			StarLinkBody* starLinkBody = new StarLinkBody(pt.getMetersX(), pt.getMetersY(), vel.getVelocityX(), vel.getVelocityY(), angle, 2.0, 0.0);
			objects.push_back(starLinkBody);
			Position pt2 = this->getPosition();
			pt2.addPixelsX(((8) * sin(this->getAngle() + 180)));
			pt2.addPixelsY(((8) * cos(this->getAngle() + 180)));
			Velocity vel2;
			vel2.setVelocityX(this->getVelocityX());
			vel2.setVelocityY(this->getVelocityY());

			vel2.setVelocityX(vel2.getVelocityX() + ((5000) * sin(this->getAngle() + 180)));
			vel2.setVelocityY(vel2.getVelocityY() + ((5000) * cos(this->getAngle() + 180)));
			StarLinkArray* starLinkArray = new StarLinkArray(pt2.getMetersX(), pt2.getMetersY(), vel2.getVelocityX(), vel2.getVelocityY(), angle, 4.0, 0.0);
			objects.push_back(starLinkArray);
			Position pt3 = this->getPosition();
			pt3.addPixelsX(((6) * sin(this->getAngle() + 90)));
			pt3.addPixelsY(((6) * cos(this->getAngle() + 90)));
			Velocity vel3;
			...
			pt4.addPixelsX(((6) * sin(this->getAngle() + 270)));
			pt4.addPixelsY(((6) * cos(this->getAngle() + 270)));
			Velocity vel4;
